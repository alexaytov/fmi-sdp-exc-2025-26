...
- Максимални ребра: \$\\frac\\{50 \\times 49\\}\\{2\\} = 1,225\$ ребра
- **Плътност**: 100%!
...
- Максимални ребра: \$\\frac\\{10^6 \\times (10^6-1)\\}\\{2\\} \\approx 5 \\times 10^\\{11\\}\$
...
- **V** = 10,000 статии
- **E** = 15,000 цитирания
- Максимални ребра: \$\\frac\\{10,000 \\times 9,999\\}\\{2\\} \\approx 50,000,000\$
