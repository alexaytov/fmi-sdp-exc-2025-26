...
<ExerciseCard
  difficulty="easy"
  timeEstimate="10 min"
  tags={["arrays", "binary-search", "basics", "theory"]}
>

### Структура от данни - дефиниция и значение
...
### Хомогенност на масивите - еднотипност на елементите
...
### Индексиране на масиви - достъп до елементи
...
### Непрекъснато разпределение на паметта и кеш ефективност
...
### Фиксиран размер на масивите и динамични алтернативи
...
### Времева сложност O(1) за достъп по индекс
...
### Инкапсулация в ООП с масиви като пример
...
### Изискване за сортираност при двоично търсене
...
### Проследяване на двоично търсене - първа стъпка
...
### Роля на конструктора в C++ класове
...
<ExerciseCard
  difficulty="medium"
  timeEstimate="15 min"
  tags={["arrays", "binary-search", "implementation", "analysis"]}
>

### Деклариране и инициализация на масив от double стойности
...
### Разлика между статични и динамични масиви в C++
...
### Изчисляване на адрес в паметта по индекс
...
### Важност на проверката на границите в масиви
...
### Стъпка по стъпка проследяване на двоично търсене
...
### Сравнение на линейно и двоично търсене - 1024 елемента
...
### Сигнатура на функция за двоично търсене в вектор от низове
...
### Дълбоко копиране в конструктора за копиране
...
### Роля на деструктора и memory leaks
...
### Избягване на integer overflow при изчисляване на mid
...
<ExerciseCard
  difficulty="hard"
  timeEstimate="20 min"
  tags={["arrays", "binary-search", "advanced", "optimization"]}
>

### Имплементация на reverse() функция на място
...
### Намиране на първото срещане с двоично търсене
...
### Анализ на сортиране + двоично търсене срещу линейно търсене
...
### Template клас ResizableArray с resize() метод
...
### Намиране на позиция за вмъкване със запазване на сортираност
...
### Амортизирана сложност при чести вмъквания в сортиран масив
...
### Debugging на бъгната имплементация на двоично търсене
...
### Имплементация на operator= със strong exception guarantee
...
### Проектиране на клас SortedArray с автоматично поддържане на сортираност
...
### Сравнителен анализ: масиви срещу други структури от данни
