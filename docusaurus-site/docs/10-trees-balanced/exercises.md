...
### Дефиниция на структура за възел
...
### Свойства на inorder обхождането
...
### Анализ на височината на дървото
...
### Построяване и обхождане на BST
...
### Приложение за телефонен указател
