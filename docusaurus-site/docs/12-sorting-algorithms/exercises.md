...
### Insertion Sort на Почти Сортирани Данни
...
### Имплементация на Merge Function
...
### Custom Comparator със std::sort
...
### Имплементация на Counting Sort
