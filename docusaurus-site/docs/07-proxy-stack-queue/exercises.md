...
sidebar_position: 2
slug: exercises
tags: [design-patterns, proxy, stack, queue, adapter, cpp, exercises]
---
...
### Основна цел на Proxy Pattern

**Каква е основната цел на Proxy дизайн шаблона?**

a) Да създаде множество инстанции на обект
b) Да предостави заместител или placeholder за друг обект, за да контролира достъпа до него
...
### Времева сложност за добавяне в края
...
### Грешка при премахване на възел
...
### RAII и предотвратяване на Memory Leaks
...
### Имплементация на Array Iterator
...
### Ранно връщане и изтичане на памет
...
### Броене на елементи в двусвързан списък
...
### Деструктор за двусвързан списък
...
### Вмъкване след итераторна позиция
...
### Анализ на проблеми с паметта в DataManager
...
### Двупосочен итератор за двусвързан списък
...
### Exception-safe вмъкване с RAII
...
### Циклични референции с shared_ptr и weak_ptr
...
### Valgrind анализ на memory leaks
...
### Двусвързан списък със Sentinel Nodes
...
### Memory Pool Allocator за възли
